...
# Registration lives at the bottom on purpose: every family module imports names
# from this one, so the package can only be loaded once those names exist. Any
# reader of the registries -- `collect_model_override_declarations`, and the
# guards that walk them -- gets a populated registry from importing this module
# alone.
from sglang.srt.arg_groups import model_overrides  # noqa: E402,F401
